...
export class SampleResourcesController {
   ...
   */
  constructor(private readonly sampleResourcesService: SampleResourcesService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateSampleResourceDto: UpdateSampleResourceDto) {
